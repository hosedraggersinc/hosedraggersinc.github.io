      ...
      <section className="flex flex-col">
        ...
        <div className="flex flex-col mb-10">
          <p className="mt-5 pt-10 pb-5">
            If you haven&apos;t already, watch the venting operation posted by
            our friends over at Blue Collar Firemen (@bluecollarfiremen) on
            Insta. You&apos;re welcome to skip right to the comment section if
            you want, but you probably know where this is going.
          </p>
          <p className="py-5">
            ...
            as someone who doesn&apos;t have a strong background in
            firefighting.
          </p>
          <p className="py-5">
            ...
            social media and argue that it&apos;s too dangerous needs to go back
            to recruit class and learn the basics of firefighting and fire
            ...
            your means of egress is bailing out a window? But you won&apos;t go
            on a roof to ventilate? Are you serious? Where did you learn to be a
          ...
          <p className="py-5">
            Let&apos;s break down what vertical venting (roof ventilation) is -
            in a nutshell, it&apos;s a process for:
          </p>
          ...
          <p className="py-5">
            ...
            others, it&apos;s ineptitude. The first fireground tactical priority
            is life safety, which includes firefighters and occupants. Water is
            great, but it can also create problems. In a superheated
            environment, you can steam burn potential survivors and yourself.
            It&apos;s best to remove the gases first with a well-coordinated
            vent, then hit it with water. A good hole up top, perhaps a louver
            cut, allows the science to take over. It only takes a few seconds
            for those gases to escape.
          </p>
          <p className="py-5">
          ...
          <p className="py-5">
            Now, this isn&apos;t for the faint of heart. You&apos;re actually
            going to see fire! Super dangerous! But wait, you&apos;re standing
            where you&apos;re supposed to, the hole is the right size, the
            interior crew was set up, and you didn&apos;t fall in?? How strange
            is that? It seems it was a perfectly safe operation and you helped
            rescue someone who left the stove on.
          </p>
          <p className="text-2xl uppercase italic pt-5">
            <FontAwesomeIcon icon={faInfo} className="mr-2" />
            <span className="bg-gradient-to-r from-red-500 to-rose-500 bg-clip-text text-transparent">
          ...
          <p className="py-5">
            ...
            that doesn&apos;t vertically vent, that&apos;s fine. But don&apos;t
            criticize other departments when you don&apos;t know what
            you&apos;re talking about, especially if they are good at what they
            do - because they train and they train hard. Whatever you do, do it
            safely. We all go home.
          </p>
        </div>
      </section>
    </article>
